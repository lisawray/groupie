...
public class MainActivity extends AppCompatActivity {
    ...
    private ArrayList<com.xwray.groupie.example.item.UpdatableItem> updatableItems;
...
//                for (int i = 0; i < 5; i++) {
//                    infiniteLoadingSection.add(new com.xwray.groupie.example.item.CardItem(color));
//                }
//            }
//        });
//
...
//
//        // Full bleed item
//        Section fullBleedItemSection = new Section(new com.xwray.groupie.example.item.HeaderItem(R.string.full_bleed_item));
//        fullBleedItemSection.add(new com.xwray.groupie.example.item.FullBleedCardItem(R.color.purple_200));
...
//            @Override public void onClick(View view) {
//                List<com.xwray.groupie.example.item.UpdatableItem> shuffled = new ArrayList<>(updatableItems);
...
//            }
//        };
//        com.xwray.groupie.example.item.HeaderItem updatingHeader = new com.xwray.groupie.example.item.HeaderItem(
...
//        for (int i = 1; i <= 12; i++) {
//            updatableItems.add(new com.xwray.groupie.example.item.UpdatableItem(rainbow200[i], i));
//        }
...
//        for (int i = 0; i < 2; i++) {
//            expandableGroup.add(new com.xwray.groupie.example.item.CardItem(rainbow200[1]));
//        }
//        groupAdapter.add(expandableGroup);
//
//        // Columns
//        Section columnSection = new Section(new com.xwray.groupie.example.item.HeaderItem(R.string.vertical_columns));
...
//        Section multipleColumnsSection = new Section(new com.xwray.groupie.example.item.HeaderItem(R.string.multiple_columns));
//        for (int i = 0; i < 12; i++) {
//            multipleColumnsSection.add(new com.xwray.groupie.example.item.SmallCardItem(rainbow200[5]));
//        }
//        groupAdapter.add(multipleColumnsSection);
//
//        // Swipe to delete (with add button in header)
//        swipeSection = new Section(new com.xwray.groupie.example.item.HeaderItem(R.string.swipe_to_delete));
//        for (int i = 0; i < 3; i++) {
//            swipeSection.add(new com.xwray.groupie.example.item.SwipeToDeleteItem(rainbow200[6]));
//        }
//        groupAdapter.add(swipeSection);
//
//        // Horizontal carousel
//        Section carouselSection = new Section(new com.xwray.groupie.example.item.HeaderItem(R.string.carousel, R.string.carousel_subtitle));
//        com.xwray.groupie.example.item.CarouselItem carouselItem = makeCarouselItem();
//        carouselSection.add(carouselItem);
//        groupAdapter.add(carouselSection);
//
//        // Update with payload
//        Section updateWithPayloadSection = new Section(new com.xwray.groupie.example.item.HeaderItem(R.string.update_with_payload, R.string.update_with_payload_subtitle));
//        for (int i = 0; i < rainbow500.length; i++) {
//            updateWithPayloadSection.add(new com.xwray.groupie.example.item.HeartCardItem(rainbow200[i], i, onFavoriteListener));
//
//        }
//        groupAdapter.add(updateWithPayloadSection);
//
//        // Infinite loading section
//        infiniteLoadingSection = new Section(new com.xwray.groupie.example.item.HeaderItem(R.string.infinite_loading));
//        groupAdapter.add(infiniteLoadingSection);
//    }
//
//    private ColumnGroup makeColumnGroup() {
//        List<com.xwray.groupie.example.item.ColumnItem> columnItems = new ArrayList<>();
//        for (int i = 1; i <= 5; i++) {
//            // First five items are red -- they'll end up in a vertical column
//            columnItems.add(new com.xwray.groupie.example.item.ColumnItem(rainbow200[0], i));
//        }
//        for (int i = 6; i <= 10; i++) {
//            // Next five items are pink
//            columnItems.add(new com.xwray.groupie.example.item.ColumnItem(rainbow200[1], i));
//        }
//        return new ColumnGroup(columnItems);
//    }
//
//    private com.xwray.groupie.example.item.CarouselItem makeCarouselItem() {
...
//        for (int i = 0; i < 30; i++) {
//            carouselAdapter.add(new com.xwray.groupie.example.item.CarouselCardItem(rainbow200[7]));
//        }
//        com.xwray.groupie.example.item.CarouselItem carouselItem = new com.xwray.groupie.example.item.CarouselItem(carouselDecoration);
...
//            if (item instanceof com.xwray.groupie.example.item.CardItem) {
//                com.xwray.groupie.example.item.CardItem cardItem = (com.xwray.groupie.example.item.CardItem) item;
...
//    private com.xwray.groupie.example.item.HeartCardItem.OnFavoriteListener onFavoriteListener = new com.xwray.groupie.example.item.HeartCardItem.OnFavoriteListener() {
//        @Override
//        public void onFavorite(final com.xwray.groupie.example.item.HeartCardItem item, final boolean favorite) {
...
//                    item.notifyChanged(com.xwray.groupie.example.item.HeartCardItem.FAVORITE);
//                }
//            }, 1000);
//        }
//    };
